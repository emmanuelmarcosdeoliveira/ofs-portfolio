...
export default function AnimateIcons() {
  return (
    <div>
      <DiCss3 className=" absolute animate-vision z-10 max-sm:hidden   rounded-xl p-1 border border-muted fill-foreground/20 dark:fill-muted/70 size-16 bottom-1/4 right-1/4" />
      <SiTypescript className="absolute -z-10 animate-invertvision max-sm:hidden  rounded-xl p-2 border border-muted fill-foreground/20 dark:fill-muted/70 size-16 left-1/4  bottom-1/5" />
