  ...
  return (
    <div className="text-center pt-6">
      ...
      <motion.p
        ...
        className="text-2xl max-sm:w-sm md:mx-auto bg-linear-to-t dark:from-cyan-500 from-blue-800 dark:via-white dark:to-cyan-700 to-blue-600 text-transparent bg-clip-text pt-6 max-w-2xl text-balance max-sm:text-left"
      >
