...
const ThemeSwitch = React.forwardRef<HTMLDivElement, ThemeSwitchProps>(
  (
    ...
    return (
      <div
        className={cn(
          "relative inline-flex h-8 rounded-full  bg-transparent p-1  transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring",
          switchWidth,
          className
        )}
      ...
      >
        {showActiveIconOnly ? (
          <div className="absolute flex inset-0 items-center justify-center">
            <div className="bg-background/50 flex h-6 items-center justify-center rounded-full text-background w-6 z-10">
