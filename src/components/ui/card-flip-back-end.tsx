...
export default function CardFlipBackEnd({
  title = "Desenvolvimento API",
  subtitle = "API Rest Full",
  description = "API segura e escalável",
  features = [
    "Criação de API",
    "Integração de API com serviços",
    "Autenticação com JWT",
    "Criação de Banco dados",
  ],
}: CardFlipProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={cn(
            ...
            "dark:shadow-lg",
            "transition-all duration-700",
            "group-hover:shadow-sm dark:group-hover:shadow-md",
                ...
                {[...Array(10)].map((_, i) => (
                  <div
                    ...
                    className={cn(
                      ...
                      "spiral-effect",
                      // Light mode (laranja)
                      "shadow-[0_0_50px_oklch(0.706_0.1583_44.118/0.5)]",
                      // Dark mode (azul claro) - usando classe customizada
                      "dark:shadow-[0_0_50px_#60d4ea/0.5]",
          ...
          <div className="absolute bottom-0 left-0 right-0 p-5">
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="relative group/icon">
                ...
                />
                <Database className="relative z-10 w-8 h-8 text-primary/60 transition-transform duration-300 group-hover/icon:scale-110 group-hover/icon:-rotate-12" />
              </div>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="pt-6 mt-6 border-t border-zinc-200 dark:border-zinc-800">
            ...
            >
              <span className="text-sm font-medium text-zinc-900 dark:text-white transition-colors duration-300 group-hover/start:text-primary dark:group-hover/start:text-primary">
                <Link
                  target="_blank"
                  href={
                    "https://wa.me/5511968336094?text=Olá,%20gostaria%20de%20saber%20mais%20informações!"
                  }
                >
                  Vamos conversar
                </Link>
      ...
      <style jsx>{`
        ...
        /* Dark mode override - mais específico */
        :global(.dark) @keyframes scale {
          0% {
            box-shadow: 0px 0px 50px #60d4ea !important;
          }
          50% {
            box-shadow: 0px 8px 20px #60d4ea !important;
          }
          100% {
            box-shadow: 0px 10px 20px #60d4ea / 0 !important;
          }
        }

        /* Força a cor azul no dark mode */
        :global(.dark) .spiral-effect {
          box-shadow: 0px 0px 50px #60d4ea !important;
        }
      `}</style>
    </motion.div>
