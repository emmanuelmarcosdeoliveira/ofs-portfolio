...
export default function CardFlipLandingPage({
  title = "Landing Page",
  subtitle = "Elegantes e modernas",
  description = "criação de Landing Page ",
  features = [
    "Copywriting persuasivo",
    "Carregamento rápido",
    "Performance otimizada",
    "converte visitas em clientes",
  ],
}: CardFlipProps) {
          ...
          <div className="absolute bottom-0 left-0 right-0 p-5">
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="relative group/icon">
                ...
                />
                <Star className="relative z-10 w-8 h-8 text-primary/60 transition-transform duration-300 group-hover/icon:scale-110 group-hover/icon:-rotate-12" />
              </div>
            </div>
          </div>
        </div>
