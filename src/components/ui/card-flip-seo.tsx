...
export interface CardFlipSeoProps {
  title?: string;
  subtitle?: string;
  description?: string;
  features?: string[];
...
export default function CardFlipSeo({
  title = "SEO",
  subtitle = "Otimização de SEO",
  description = "Otimização para mecanismos de busca",
  features = [
    "Aumento do tráfico orgânico",
          ...
          <div className="absolute bottom-0 left-0 right-0 p-5">
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="relative group/icon">
                ...
                />
                <Rocket className="relative z-10 w-8 h-8 text-primary/60 transition-transform duration-300 group-hover/icon:scale-110 group-hover/icon:-rotate-12" />
              </div>
            </div>
          </div>
        </div>
